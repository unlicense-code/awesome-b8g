// sysroots["bullseye-x64"].v8.Dockerfile
const meta = ['bullseye-x64',['v8/Dockerfile']];
const sysroots = [{ "bullseye-x64": { 
  "v8": {
    "Dockerfile": `# Note that this is exactly what docker build does for each RUN defined layer
