...
int NAMESPACE::CreateIsolate(int argc, char** argv, const char* main_src, 
  ...
  return CreateIsolate(argc, argv, main_src, main_len, NULL, 0, NULL, 0, start, "isolate", "main.js");
}
...
void NAMESPACE::Init(Isolate* isolate, Local<ObjectTemplate> target) {
  ...
  SET_VALUE(isolate, version, "isolate", String::NewFromUtf8Literal(isolate, 
    VERSION));
